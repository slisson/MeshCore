...
void CommonCLI::loadPrefsInt(FILESYSTEM* fs, const char* filename) {
  ...
  if (file) {
    ...
    file.read((uint8_t *)&_prefs->qos_packets_per_hour, sizeof(_prefs->qos_packets_per_hour)); // next: 290
    // 292
...
void CommonCLI::savePrefs(FILESYSTEM* fs) {
  ...
  if (file) {
    ...
    file.write((uint8_t *)&_prefs->qos_packets_per_hour, sizeof(_prefs->qos_packets_per_hour));  // next: 290
    // 292
